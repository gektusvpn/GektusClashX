...
object SavedParams {
    private const val PARAMS_FILE = "gektusclashx_always_on.json"
    private const val ACTIVE_FILE = "gektusclashx_vpn_active"
    private const val NOTIF_TITLE_FILE = "gektusclashx_notif_title"
    private const val START_TIME_FILE = "gektusclashx_start_time"
    private const val CRASHLYTICS_OPTOUT_FILE = "gektusclashx_crashlytics_optout"
    ...
    fun loadNotificationTitle(): String =
        runCatching { notifTitleFile.readText().trim() }.getOrDefault("").ifBlank { "GektusClashX" }
