package com.gektus.clashx.service.modules
...
import com.gektus.clashx.common.buildServiceNotification
import com.gektus.clashx.common.startForegroundSafely
import com.gektus.clashx.service.Module
import com.gektus.clashx.service.State
...
class NotificationModule(service: Service) : Module(service) {
    ...
    private fun ensureChannel() {
        ...
        val channel = NotificationChannel(
            ...
            service.getString(com.gektus.clashx.common.R.string.notification_channel_name),
    ...
    private fun buildNotification(title: String, stopText: String = ""): android.app.Notification {
        return service.buildServiceNotification(
            com.gektus.clashx.service.R.drawable.ic_notification,
            title,
            stopText,
        )
    }
