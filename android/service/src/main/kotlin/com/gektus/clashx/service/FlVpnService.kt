...
import com.gektus.clashx.common.GlobalState
import com.gektus.clashx.common.SavedParams
import com.gektus.clashx.common.promoteToForeground
import com.gektus.clashx.core.Core
import com.gektus.clashx.core.InvokeInterface
import com.gektus.clashx.service.models.VpnOptions
import com.gektus.clashx.service.models.gsonSanitized
import com.gektus.clashx.service.models.toCIDR
import com.gektus.clashx.service.modules.HealthCheckModule
import com.gektus.clashx.service.modules.NetworkObserveModule
import com.gektus.clashx.service.modules.NotificationModule
import com.gektus.clashx.service.modules.SuspendModule
...
class FlVpnService : VpnService(), IBaseService {
    ...
    private fun acquireWakeLock() {
        synchronized(wakeLockLock) {
            ...
            runCatching {
                ...
                wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "GektusClashX:vpn-tunnel").apply {
    ...
    companion object {
        const val ACTION_STOP = "com.gektus.clashx.service.STOP"
    }
    ...
    private suspend fun coldStartLocked() {
        ...
        if (coreResult == null) {
            ...
            SavedParams.setVpnActive(false)
            runCatching { com.gektus.clashx.core.Core.stopTun() }
            stopForegroundCompat()
            stopSelf()
            return
        }
    ...
    override suspend fun handleStart(options: VpnOptions) {
        ...
        runCatching {
            ...
            if (ac != null) {
                when (ac.mode) {
                    com.gektus.clashx.common.AccessControlMode.acceptSelected ->
                        allInclude.addAll(ac.acceptList)
                    com.gektus.clashx.common.AccessControlMode.rejectSelected ->
        ...
        try {
            ...
            val started = com.gektus.clashx.core.Core.startTun(
                fd = fd,
