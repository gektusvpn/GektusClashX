...
import com.gektus.clashx.common.chunkedForAidl
import com.gektus.clashx.common.intent
...
class RemoteService : Service() {
    ...
    private val eventListener = AtomicReference<com.gektus.clashx.service.IEventInterface?>(null)
    ...
    private val stub = object : IRemoteInterface.Stub() {
        ...
        override fun quickStart(
            ...
            GlobalState.launch {
                com.gektus.clashx.common.SavedParams.saveQuickStartParams(
        ...
        override fun updateNotificationParams(params: NotificationParams) {
            ...
            com.gektus.clashx.common.SavedParams.saveNotificationTitle(params.title)
        }
        ...
        override fun startService(options: VpnOptions, runTime: Long, result: IResultInterface) {
            GlobalState.launch {
                State.runLock.withLock {
                    ...
                    if (options.enable) com.gektus.clashx.common.SavedParams.setVpnActive(true)
        ...
        override fun setEventListener(event: com.gektus.clashx.service.IEventInterface?) {
    ...
    private fun deleteStaleChannels() {
        ...
        runCatching { mgr.deleteNotificationChannel("GektusClashX_Core") }
    }
}
