...
import com.gektus.clashx.RunState
import com.gektus.clashx.Service
import com.gektus.clashx.common.Components
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "saveParams" -> {
                ...
                com.gektus.clashx.common.SavedParams.saveQuickStartParams(init, params, state)
                result.successOnMain(true)
            }
    ...
    private fun handleShowSubscriptionNotification(call: MethodCall, result: MethodChannel.Result) {
        ...
        runCatching {
            ...
            val builder = NotificationCompat.Builder(ctx, GlobalState.SUBSCRIPTION_NOTIFICATION_CHANNEL)
                .setSmallIcon(com.gektus.clashx.service.R.drawable.ic_notification)
