package com.gektus.clashx

import android.content.Context
import android.content.Intent
import android.util.Log
import androidx.lifecycle.MutableLiveData
import com.gektus.clashx.common.GlobalState as CommonGlobalState
import com.gektus.clashx.extensions.getActionIntent
...
object GlobalState {
    ...
    const val NOTIFICATION_CHANNEL = "GektusClashX"
    const val SUBSCRIPTION_NOTIFICATION_CHANNEL = "GektusClashX_Subscription"
            ...
            runStateFlow.collect { state ->
                withContext(Dispatchers.Main) {
                    ...
                    if (state != RunState.PENDING) {
                        ...
                        runCatching {
                            com.gektus.clashx.services.GektusClashXTileService.requestUpdate(
                        ...
                        runCatching {
                            ...
                            for (cls in arrayOf(
                                com.gektus.clashx.widgets.OnOffWidgetProvider::class.java,
                                com.gektus.clashx.widgets.ModeWidgetProvider::class.java,
                            )) {
    ...
    suspend fun handleSyncState() {
        runLock.withLock {
            ...
            if (com.gektus.clashx.common.SavedParams.isVpnActive()) {
                if (runTime == 0L) {
                    runTime = com.gektus.clashx.common.SavedParams.getStartTime()
    ...
    fun handleToggle() {
        CommonGlobalState.launch {
            runLock.withLock {
                ...
                val running = com.gektus.clashx.common.SavedParams.isVpnActive() ||
    ...
    private fun schedulePendingTimeout() {
        ...
        pendingTimeoutJob = CommonGlobalState.launch {
            ...
            val hasSaved = com.gektus.clashx.common.SavedParams.loadQuickStartParams() != null
            if (hasSaved && !com.gektus.clashx.common.SavedParams.isVpnActive()) {
                runLock.withLock {
    ...
    private suspend fun startHeadlessFromSaved() {
        ...
        com.gektus.clashx.common.SavedParams.setVpnActive(true)
        runCatching {
            val intent = android.content.Intent(ctx, com.gektus.clashx.service.FlVpnService::class.java)
            androidx.core.content.ContextCompat.startForegroundService(ctx, intent)
            runStateFlow.tryEmit(RunState.START)
        }.onFailure {
            Log.w(TAG, "startHeadlessFromSaved: start failed: ${it.message}")
            com.gektus.clashx.common.SavedParams.setVpnActive(false)
            runStateFlow.tryEmit(RunState.STOP)
        }
    }
    ...
    private suspend fun triggerStart() {
        ...
        val hasSavedParams = com.gektus.clashx.common.SavedParams.loadQuickStartParams() != null
        if (!hasSavedParams) {
            runStateFlow.tryEmit(RunState.STOP)
            TilePlugin.setPendingAction(TilePlugin.PendingAction.START)
            launchMainActivity()
    ...
    private suspend fun triggerStop() {
        ...
        if (runStateFlow.value == RunState.STOP &&
            !com.gektus.clashx.common.SavedParams.isVpnActive()) return
        ...
        runCatching {
            val ctx = CommonGlobalState.application
            val stopIntent = android.content.Intent(ctx, com.gektus.clashx.service.FlVpnService::class.java)
                .setAction(com.gektus.clashx.service.FlVpnService.ACTION_STOP)
